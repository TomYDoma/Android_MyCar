...
import static com.example.mycar.MainActivity.calculateBalance;
import static com.example.mycar.MainActivity.checkIfEmpty;
import static com.example.mycar.MainActivity.setBalance;
...
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.TViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TransactionAdapter.TViewHolder holder, int position) {
        ...
        holder.tvComment.setText(transactionList.get(holder.getAdapterPosition()).getComment());

        // Если транзакция положительная (получены деньги), устонавливаем цвет текста на зеленый
        if(transactionList.get(holder.getAdapterPosition()).isPositive())
        {
            ...
            holder.tvAmount.setText("+"+Integer.toString(transactionList.get(holder.getAdapterPosition()).getAmount())+ "р");
        }

        // Если транзакция отрицательная (потрачены деньги), устонавливаем цвет текста на красный
        else {
        ...
        // Слушатель для кнопки удаления операции
        holder.ivDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(ctx)
                        .setCancelable(false)
                        .setTitle("Вы точно хотите удалить эту транзакцию?")
    ...
    public static class TViewHolder extends RecyclerView.ViewHolder{
        TextView tvAmount,tvMessage, tvDate, tvComment;
        ImageView ivDelete;
